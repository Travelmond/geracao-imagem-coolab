...
def on_ui_tabs():
    ...
    """
    with gr.Blocks(analytics_enabled=False, elem_id="cache-manager-tab") as cache_manager_tab:
        ...
        refresh_btn = gr.Button("🔄 Atualizar Recursos", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'])
        ...
        with gr.Accordion("⚙️ Configurações", open=False):
            ...
            with gr.Row():
                save_config_btn = gr.Button("💾 Salvar Config", variant="primary", elem_classes=['cm-btn', 'cm-btn-primary'])
                restore_default_btn = gr.Button("🔄 Restaurar Padrão", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'])
                restore_session_btn = gr.Button("📋 Restaurar Última Sessão", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'])
        ...
        with gr.Accordion("📥 Download por URL (Drive)", open=False):
            ...
            with gr.Row():
                dl_btn = gr.Button("⬇️ Baixar para o Drive", variant="primary", elem_classes=['cm-btn', 'cm-btn-primary'])
        ...
        with gr.Accordion("📤 Upload do PC para o Drive", open=False):
            with gr.Row():
                ...
                up_btn = gr.Button("📤 Enviar para o Drive", variant="primary", elem_classes=['cm-btn', 'cm-btn-primary'], scale=1)
        ...
        with gr.Tabs(visible=True):
            for model_type in MODEL_TYPES:
                ...
                with gr.Tab(label, interactive=True, visible=True):
                    ...
                    with gr.Row():
                        cache_btn = gr.Button("📥 Cache", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'], scale=1)
                        ram_btn = gr.Button("🧠 RAM", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'], scale=1)
                        vram_btn = gr.Button("🎯 VRAM", variant="primary", elem_classes=['cm-btn', 'cm-btn-primary'], scale=1)
                        rm_disk_btn = gr.Button("🗑️ Disco", variant="stop", elem_classes=['cm-btn', 'cm-btn-danger'], scale=1)
                        rm_ram_btn = gr.Button("🗑️ RAM", variant="stop", elem_classes=['cm-btn', 'cm-btn-danger'], scale=1)
        ...
        with gr.Row():
            sync_btn = gr.Button("📥 Sincronizar Selecionados", variant="primary", elem_classes=['cm-btn', 'cm-btn-primary'], scale=2)
            copy_all_btn = gr.Button("📥 Copiar Tudo", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'], scale=1)
            clear_cache_btn = gr.Button("🗑️ Limpar Cache", variant="stop", elem_classes=['cm-btn', 'cm-btn-danger'], scale=1)
        ...
        with gr.Row():
            save_cache_btn = gr.Button("💾 Salvar Cache → Drive", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'], scale=2)
            save_images_btn = gr.Button("📤 Salvar Imagens no Drive", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'], scale=2)
        ...
        with gr.Accordion("📋 Log da Sessão", open=True):
            ...
            with gr.Row():
                refresh_log_btn = gr.Button("🔄 Atualizar Log", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'])
                save_log_btn = gr.Button("💾 Salvar Log no Drive", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'])
                clear_log_btn = gr.Button("🧹 Limpar Log", variant="secondary", elem_classes=['cm-btn', 'cm-btn-info'])
